/*
 ...
 Source Server         : 192.168.31.81-3307
 Source Server Type    : MySQL
 Source Server Version : 80026
 Source Host           : 192.168.31.81:3307
 Source Schema         : myapp
...
CREATE TABLE `news`  (
  `news_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '资讯id',
  ...
  `type` int(0) NULL DEFAULT NULL COMMENT '资讯显示类型',
...
CREATE TABLE `news_thumb`  (
  `thumb_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '缩略图id',
  `thumb_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '缩略图url',
  `news_id` int(0) NULL DEFAULT NULL COMMENT '资讯id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 207 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '定时任务日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_log` VALUES (26, 'admin', '修改菜单', 'io.renren.modules.sys.controller.SysMenuController.update()', '[{\"menuId\":32,\"parentId\":31,\"name\":\"视频列表\",\"url\":\"app/videolist\",\"type\":1,\"icon\":\"zhedie\",\"orderNum\":0,\"list\":[]}]', 11, '0:0:0:0:0:0:0:1', '2021-09-26 19:46:49');
INSERT INTO `sys_log` VALUES (27, 'admin', '删除菜单', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[37]', 3, '0:0:0:0:0:0:0:1', '2021-09-26 19:52:36');
INSERT INTO `sys_log` VALUES (28, 'admin', '删除菜单', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[38]', 24, '0:0:0:0:0:0:0:1', '2021-09-26 19:52:45');
INSERT INTO `sys_log` VALUES (29, 'admin', '删除菜单', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[38]', 7, '0:0:0:0:0:0:0:1', '2021-09-26 19:52:47');
INSERT INTO `sys_log` VALUES (30, 'admin', '删除菜单', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[37]', 3, '0:0:0:0:0:0:0:1', '2021-09-26 19:52:51');
INSERT INTO `sys_log` VALUES (31, 'admin', '删除菜单', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[39]', 11, '0:0:0:0:0:0:0:1', '2021-09-26 19:52:55');
INSERT INTO `sys_log` VALUES (32, 'admin', '删除菜单', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[41]', 11, '0:0:0:0:0:0:0:1', '2021-09-26 19:53:02');
INSERT INTO `sys_log` VALUES (33, 'admin', '删除菜单', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[40]', 11, '0:0:0:0:0:0:0:1', '2021-09-26 19:53:08');
INSERT INTO `sys_log` VALUES (34, 'admin', '删除菜单', 'io.renren.modules.sys.controller.SysMenuController.delete()', '[37]', 11, '0:0:0:0:0:0:0:1', '2021-09-26 19:53:14');
INSERT INTO `sys_log` VALUES (35, 'admin', '修改用户', 'io.renren.modules.sys.controller.SysUserController.update()', '[{\"userId\":1,\"username\":\"admin\",\"salt\":\"YzcmCZNvbXocrsz9dm8e\",\"email\":\"root@qq.com\",\"mobile\":\"13612345678\",\"status\":1,\"roleIdList\":[2,3],\"createUserId\":1}]', 114, '0:0:0:0:0:0:0:1', '2021-09-26 20:02:54');
INSERT INTO `sys_log` VALUES (36, 'admin', '修改用户', 'io.renren.modules.sys.controller.SysUserController.update()', '[{\"userId\":1,\"username\":\"admin\",\"salt\":\"YzcmCZNvbXocrsz9dm8e\",\"email\":\"root@qq.com\",\"mobile\":\"13612345678\",\"status\":1,\"roleIdList\":[3],\"createUserId\":1}]', 15, '0:0:0:0:0:0:0:1', '2021-09-26 20:03:15');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, 'app', 'app端登录用户', 1, '2021-07-06 17:59:38');
INSERT INTO `sys_role` VALUES (2, '系统管理员', '后台系统管理员', 1, '2020-07-19 18:01:43');
INSERT INTO `sys_role` VALUES (3, '超级管理员', '超级管理员', 1, '2021-07-06 18:03:06');
...
CREATE TABLE `sys_user_role`  (
  ...
  `role_id` bigint(0) NULL DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户与角色对应关系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `video_list`  (
  `vid` int(0) NOT NULL AUTO_INCREMENT COMMENT '视频id\r\n',
  ...
  `comment_num` int(0) NULL DEFAULT NULL COMMENT '用户评论数',
  ...
  `category_id` int(0) NULL DEFAULT NULL COMMENT '视频分类ID',
...
INSERT INTO `video_list` VALUES (11, '萨德：有钱学森弹道就可以“为所欲为”么', '军武次位面', 'https://p3-xg.byteimg.com/img/tos-cn-i-0004/bd1c46a6e99a491cab93ae359df1a287~tplv-crop-center:1041:582.jpg', 'https://p3.pstatp.com/large/888f000186913353fe3f', 123, 500, 320, 'http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4', '2021-07-06 16:05:38', '2021-07-06 01:58:19', 8);
...
INSERT INTO `video_list` VALUES (16, '拇指琴演奏《琅琊榜》插曲《红颜旧》琴声动人', '比三呆', 'https://p1-xg.byteimg.com/img/tos-cn-p-0000/527b08d0f31d4705a4d8f4a72120948c~tplv-crop-center:1041:582.jpg', 'https://p3.pstatp.com/large/dac80011227f8d67d02b', 34, 456, 123, 'http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4', '2021-07-06 16:05:38', '2021-07-06 01:58:44', 2);
INSERT INTO `video_list` VALUES (17, '陈志朋台上唱《大田后生仔》', '下饭音乐', 'https://p3-xg.byteimg.com/img/tos-cn-i-0004/1820c36d7a3846acaca9c24f18b01944~tplv-crop-center:1041:582.jpg', 'https://p1.pstatp.com/large/8b5f000540ca210dc4a7', 76, 47, 768, 'http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4', '2021-07-06 16:05:38', '2021-07-06 01:58:47', 2);
INSERT INTO `video_list` VALUES (18, '龚喜水库下网偶遇大鱼群，收网过程惊心动魄', '游钓寻鱼之路', 'https://p3-xg.byteimg.com/img/tos-cn-p-0026/a225869a56d1715823d6f74d6a765b01~tplv-crop-center:1041:582.jpg', 'https://p3.pstatp.com/large/da57000d5b84204f3e8f', 43, 46, 78, 'http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4', '2021-07-06 22:39:15', '2021-07-06 01:58:50', 4);
...
INSERT INTO `video_list` VALUES (20, '管它什么狂风暴雨昼夜不停,躲在房车里炖牛肉', '旗开得胜号', 'https://p3-xg.byteimg.com/img/tos-cn-i-0004/55386236bbf74f5794251a24fba85ef1~tplv-crop-center:1041:582.jpg', 'https://p1.pstatp.com/large/986a0004c8fa4adec094', 776, 67, 23, 'http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4', '2021-07-06 16:05:38', '2021-07-06 01:59:02', 5);
...
INSERT INTO `video_list` VALUES (22, '云南咖啡进军美国第一步：纽约最好烘焙厂愿意合作吗？', '我是郭杰瑞', 'https://p1-xg.byteimg.com/img/tos-cn-i-0004/4a482126d41c4da49c3baaa5ea65b0f6~tplv-crop-center:1041:582.jpg', 'https://p1.pstatp.com/large/4e6900026fa8d9eaee0a', 43, 654, 21, 'http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4', '2021-07-06 16:05:38', '2021-07-06 01:59:13', 5);
INSERT INTO `video_list` VALUES (23, '二货当憨头面炫耀家庭地位，谁料事后认怂惨遭打脸', '爆笑三江锅', 'https://p1-xg.byteimg.com/img/tos-cn-i-0004/975b48746c584e79b77df1a43531d4bf~tplv-crop-center:1041:582.jpg', 'https://p3.pstatp.com/large/ef40008c39119bef556', 56, 3435, 74, 'http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4', '2021-07-06 16:05:38', '2021-07-06 01:59:19', 6);
...
INSERT INTO `video_list` VALUES (25, '猫一见陌生人就跑，靠近就发抖', '肉蛋儿有个喵', 'https://p3-xg.byteimg.com/img/tos-cn-i-0004/eadd7aebf3174fa3b793acd310d2549a~tplv-crop-center:1041:582.jpg', 'https://p3.pstatp.com/large/289a0019c8fc986e193f', 45, 234, 6, 'http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4', '2021-07-06 16:05:38', '2021-07-06 01:59:27', 7);
