...
public class SysOssController {
    ...
    @RequiresPermissions("sys:oss:all")
    public ReturnData saveConfig(@RequestBody CloudStorageConfig config) {
        //校验类型
    ...
    @PostMapping("/upload")
    @RequiresPermissions("sys:oss:all")
    public ReturnData upload(@RequestParam("file") MultipartFile file) throws Exception {
        if (file.isEmpty()) {
        ...
        return ReturnData.ok().put("url", url);
    }
